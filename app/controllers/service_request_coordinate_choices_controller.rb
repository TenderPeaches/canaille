class ServiceRequestCoordinateChoicesController < ApplicationController
    def new
        ...
        if params[:use_client_address]
            ...
            choice_result = ServiceRequests::FormAddressPicker.new(current_user, @service_request).use_client_address

            render "service_requests/use_client_address"
        elsif params[:use_unique_address]

            choice_result = ServiceRequests::FormAddressPicker.new(current_user, @service_request).use_unique_address
